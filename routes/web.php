...
Route::get('/category/{slug}', 'ProductsController@categoryWiseProductListing');
...
Route::get('/sitemap', function () {
    SitemapGenerator::create('https://freshnfinds.com/')->writeToFile('sitemap.xml');
...
Route::get('checkpay', 'razorpay\PaymentController@checkPay');
