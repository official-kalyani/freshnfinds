...
Route::post('placeOrderNew','ApiController@placeOrderNew');
...
// Route::post('deliverysignUp','ApiController@deliverysignUp');
Route::post('deliverylogin','ApiController@deliverylogin');
// Route::post('deliverylogin2','ApiController@deliverylogin2');
Route::post('upcomingdelivery','ApiController@upcomingdelivery');
Route::post('cancelleddelivery','ApiController@cancelleddelivery');
Route::post('pastdelivery','ApiController@pastdelivery');
Route::post('orderDetail','ApiController@orderDetail');
Route::post('deliveryorderupdate','ApiController@deliveryorderupdate');
