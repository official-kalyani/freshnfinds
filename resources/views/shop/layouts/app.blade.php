    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/shop/home')}}" class="nav-link {{ request()->is('shop/home') ? 'active' : '' }}">
          ...
          <li class="nav-item {{ request()->is('shop/master-products') ? 'has-treeview menu-open' : '' }}">
            <a href="#" class="nav-link {{ request()->is('shop/master-products') ? 'active' : '' }}">
          ...
          <li class="nav-item {{ request()->is('shop/products') ? 'has-treeview menu-open' : '' }}">
            <a href="#" class="nav-link {{ request()->is('shop/products') ? 'active' : '' }}">
              <i class="nav-icon fas fa-th"></i>
              <p>
                My Products
                <i class="right fas fa-angle-left"></i>
