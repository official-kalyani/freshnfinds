                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-xl-2 col-lg-2 col-sm-12 col-12">
                            <a class="navbar-brand" href="{{url('/')}}"><img src="{{ URL::to('/') }}/images/headerlogo.png" alt="logo" class="w-100"></a>
                        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <a target="_blank" href="#"><img src="{{ URL::to('/') }}/images/gplay.png" alt="" class="img-fluid"></a>    
                    </div>
                      
                    </div>
                    <div class="text-center">
                    <p>Copyright&copy; 2020 <a href="https://freshnfinds.com/">Freshnfinds</a>  |   All right Reserved   | Crafted With Perfection by <a href="https://www.rixosys.com/" target="_blank">Rixosys</a> </p>
            ...
            <div class="row" id="loginModal_content">
                ...
                <form id="loginWithPassword" class="theme-form">
                        ...
                        <div class="clearfix">
                            ...
                            <a href="#" id="forgot_password_modal" class="float-right" data-toggle="modal" data-target="#forgotModal" data-dismiss="modal">Forgot Password?</a>
                        </div>
                        ...
                        <p class="text-center text-muted small">Don't have an account? <a href="#" data-toggle="modal" data-target="#signupModal" data-dismiss="modal">Sign up here!</a></p> 
                    </form>
                </div>
                </div>
            </div>
                        ...
                        <h1 class="text-center">Signup</h1>
                            <div class="theme-card">
                                <form id="signUpForm">
                                    ...
                                    <p class="text-center text-muted small">Already Have an account? <a href="#" class="loginModal" data-toggle="modal" data-target="#loginModal" data-dismiss="modal">Login in here!</a></p>
                                </form>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <h1 class="text-center">Forgot Password</h1>
                            ...
                            <div class="form-group">
                                <label for="forgot_email_phone" class="col-form-label text-md-right">{{ __('E-Mail') }} <span class="error">*</span></label>
                                <input id="forgot_email_phone" placeholder="Enter your email" type="text" class="form-control" name="forgot_email_phone">
                            </div>
                            <span style="color: red;" id="forgotpassword_message"></span>
                            <div class="form-group mb-0">
                                <div class="col-form-label">
