                                    ...
                                    <div class="product-text">
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="col-md-12">
                                           ...
                                           @else
                                             <a href="{{url('/customize')}}?product_id={{$product->id}}&return_url={{$actual_link}}" class="btn cart-btn a_btn">Customize</a>
                                           @endguest
                                         </div>
                                         @endif                             -->
                                     </div>
        ...
        submitHandler: function (form) {
            ...
            if (payment_type == "cod") {
                ...
                $.ajax({
                   ...
                   "name": "FreshNFinds",
                   "description": "FreshNFinds Payment",
                   "image": "https://freshnfinds.com/images/headerlogo.png",
