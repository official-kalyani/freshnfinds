...
class ProductsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            {
                return back()->with('flash_failure', 'Product Name Already exists!');
            }
            else
            {
                $shop = new Product;
    ...
    public function step2(Request $request)
    {
        if (isset($request->id) && $request->id !='') {
            ...
            // exit(); 
            return view('admin.products.step2',compact('images','subcategories','subcategory_id','products','product_price','data','checkCategory','occasions','occasion_id'));
        }
        else{
